---
title: "Mapping Review from Group 3"
...
Floyd_rain <- Floyd_rain %>% 
  mutate(`Rainfall (mm)` = cut(Floyd_rain$precip, 
      ## From Group 3: we change breaks = c(0, 25, 50, 75, 100, 125, 150, 175, 200, 225) into breaks=seq(0,200,25) to make code looks clear
                     breaks = seq(0, 200, 25),
                     include.lowest = TRUE))
...
ggplot() + geom_polygon(data = Floyd_rain, aes(x = long, y = lat, group = group, 
  ...
  ##From Group 3: we add restriction on the map to make it looks clearer
